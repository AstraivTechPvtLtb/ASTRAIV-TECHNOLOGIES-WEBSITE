 ...
 * @description AI orchestration service interface and mock provider for Astraiv AI capabilities.
 */
...
export class MockAIService implements AIService {
  ...
  async generateStructuredData<T>(_prompt: string, _schema: string, _options?: AIGenerateOptions): Promise<T> {
  ...
  async chat(messages: AIChatMessage[], _options?: AIGenerateOptions): Promise<string> {
