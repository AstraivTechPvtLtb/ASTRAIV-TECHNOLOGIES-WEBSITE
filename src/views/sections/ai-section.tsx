...
export function AiSection() {
  const capabilities = [
    ...
    {
      icon: <DatabaseZap className="h-4 w-4 text-primary dark:text-cyan-400" />,
  ...
  return (
    <section id="ai-expertise" className="py-20 md:py-28 px-6 bg-transparent relative overflow-hidden scroll-mt-24">
      ...
      <div className="absolute top-1/2 right-10 w-[600px] h-[400px] bg-cyan-500/5 rounded-full blur-[160px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 mt-14 sm:mt-16 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="absolute top-5 left-5">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-950/80 backdrop-blur-md border border-cyan-400/40 text-cyan-300 font-extrabold text-xs uppercase tracking-wider shadow-lg">
            ...
            <div className="absolute bottom-5 left-5 right-5 p-4 rounded-xl bg-slate-950/80 backdrop-blur-md border border-cyan-400/20 text-white flex flex-col gap-2">
          ...
          <div className="lg:col-span-6 flex flex-col gap-4 text-left">
            {capabilities.map((cap, index) => (
              <motion.div
                ...
                className="group p-5 sm:p-6 bg-card/85 dark:bg-slate-900/80 backdrop-blur-xl border border-border/70 dark:border-slate-800/80 hover:border-primary/40 dark:hover:border-cyan-400/40 rounded-[20px] shadow-xs hover:shadow-[0_12px_30px_-10px_rgba(11,61,145,0.08)] dark:hover:shadow-[0_12px_30px_-10px_rgba(0,194,255,0.1)] transition-all duration-300 transform-gpu hover:-translate-y-1 flex items-start gap-4"
              >
            ...
            <div className="pt-3 flex items-center justify-between">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-extrabold text-primary dark:text-cyan-400 hover:text-primary/80 dark:hover:text-cyan-300 transition-colors group"
              >
