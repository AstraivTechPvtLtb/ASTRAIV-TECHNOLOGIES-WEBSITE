  ...
  groups: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: ROUTES.PUBLIC.SERVICE_DETAIL('web-applications'),
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Sprint Velocity & SLA Metrics',
          href: ROUTES.PUBLIC.WORK_TESTIMONIALS,
          description: '99.8% on-time sprint completion with zero architectural debt.',
          badge: '99.8% On-Time',
        },
        {
          name: 'Verified Production Reviews',
          href: ROUTES.PUBLIC.WORK_TESTIMONIALS,
          description: 'Validated client reviews across custom AI, SaaS, and cloud delivery.',
          badge: 'Top Rated',
        },
        {
          name: 'Explore Testimonials →',
          href: ROUTES.PUBLIC.WORK_TESTIMONIALS,
          description: 'Discover why high-growth companies trust Astraiv with their technology.',
        },
      ],
    },
  ],
