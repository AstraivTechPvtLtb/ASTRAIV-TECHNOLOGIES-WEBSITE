...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from '@/views/ui/dialog';
import { formatDate } from '@/utils';
import { cn } from '@/lib/utils';
import { createTicketAction } from '@/controllers/tickets.controller';
...
export function TicketsView({ tickets, clientId }: TicketsViewProps) {
                        ...
                        {ticket.assignedTo ? (
                          <div className="flex items-center gap-2">
                            {ticket.assignedTo.image ? (
                              <Image src={ticket.assignedTo.image} alt={ticket.assignedTo.name} width={24} height={24} className="h-6 w-6 rounded-full object-cover" />
                            ) : (
